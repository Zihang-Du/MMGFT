    ...
    "messages": [
      ...
      },
      {
        ...
        "content": [
          {
            "type": "text",
            "text": "This is an advertising metaphor. Please select the most likely source domain from the image and text based on the image and text as well as the target domain."
          }
        ]
      },
      {
...
# print(len(pic_id))
count = 0
file_path = 'D:/PycharmProject/SourceGeneration/Output/GPT_PS_result_Meme.xlsx'
...
#
# # 将DataFrame写入Excel文件
# df.to_excel('D:/PycharmProject/SourceGeneration/Output/GPT_SP_result.xlsx', index=False)